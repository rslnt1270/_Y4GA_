...
echo "========================================================"
echo ""
echo " Ubuntu (us-east-1) — puerto 6285 (SG: sg-0486cecc1922afa30):"
echo "   ssh -i $UBUNTU_PEM $UBUNTU_HOST"
...
echo ""
echo " EC2 testing (us-east-2) — puerto 8000:"
echo "   ssh -i $EC2_PEM $EC2_HOST"
echo "   source ~/venv/bin/activate && cd ~/venv/www/testing"
echo "   python manage.py runserver 0.0.0.0:8000"
echo "   → http://ec2-13-58-246-32.us-east-2.compute.amazonaws.com:8000/xray/"
echo ""
echo " Puertos abiertos: bash infrastructure/configure_ec2_ports.sh all"
