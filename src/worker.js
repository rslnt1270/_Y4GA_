...
const SECURITY_HEADERS = {
  ...
  'Content-Security-Policy': [
    ...
    "font-src 'self' data:",
    "connect-src 'self' https://ec2-3-19-35-76.us-east-2.compute.amazonaws.com wss://ec2-3-19-35-76.us-east-2.compute.amazonaws.com https://nominatim.openstreetmap.org https://router.project-osrm.org https://*.basemaps.cartocdn.com https://cdn.jsdelivr.net",
    "worker-src 'self'",
    "manifest-src 'self'",
